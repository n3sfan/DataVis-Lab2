...
COUNTRIES = [
    # --- Đông Nam Á (ASEAN) ---
    "VNM", "THA", "IDN", "PHL", "MYS", "SGP", "MMR", "KHM", "LAO", "BRN",
    
    # --- Đông Á & Thái Bình Dương ---
    "CHN", "JPN", "KOR", "AUS", "NZL", "MNG", "PNG", "FJI", "SLB", "VUT",
    
    # --- Nam Á ---
    "IND", "PAK", "BGD", "LKA", "NPL", "AFG", "MDV", "BTN",
    
    # --- Châu Âu & Trung Á ---
    "DEU", "FRA", "GBR", "ITA", "ESP", "NLD", "BEL", "SWE", "NOR", "DNK",
    "FIN", "CHE", "AUT", "POL", "PRT", "GRC", "ROU", "HUN", "CZE", "IRL",
    "UKR", "RUS", "TUR", "KAZ", "UZB", "AZE", "GEO", "ARM", "TJK", "KGZ",
    
    # --- Bắc Mỹ ---
    "USA", "CAN", "BMU",
    
    # --- Mỹ Latinh & Caribe ---
    "BRA", "MEX", "ARG", "COL", "CHL", "PER", "ECU", "VEN", "URY", "PRY",
    "BOL", "CRI", "PAN", "CUB", "DOM", "GTM", "HND", "SLV", "NIC", "JAM",
    
    # --- Trung Đông & Bắc Phi ---
    "EGY", "SAU", "ARE", "ISR", "IRN", "IRQ", "MAR", "DZA", "QAT", "KWT",
    "JOR", "LBN", "TUN", "LBY", "OMN",
    
    # --- Châu Phi cận Sahara ---
    "ZAF", "NGA", "ETH", "KEN", "GHA", "TZA", "AGO", "CIV", "SEN", "RWA",
    "UGA", "CMR", "ZMB", "MWI", "ZWE", "NAM", "BWA", "MOZ"
]
